<template lang="pug">
  .form-view
    .form-area--header
      .form-view-title Nouvelle oeuvre
      .form-view-subtitle Vidéo
    form.form-area(name="show-form" @submit.prevent="")
      .form-sector
        .form-sector-title Spectacle
